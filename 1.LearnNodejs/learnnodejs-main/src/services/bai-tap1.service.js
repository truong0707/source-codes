 ...
 */
const cau1 = async () => {
  const lops = await Lop.find('CS19A1A').select('MaSV HoTen Nu NgaySinh MaLop HocBong');
  return lops;
};
 ...
 */
 const cau1 = async () => {
  const results = await SinhVien.find('HocBong').select('MaSV Nu HocBong');
  return results;
};
 ...
 */
 const cau2 = async () => {
  const results = await SinhVien.find().where('nam').equals('sinhvien');
  return results;
};
 ...
 */
 const cau3 = async () => {
  const results = await Lop.find().where('Khoa');
  return results;
};
 ...
 */
 const cau4 = async () => {
  const results = await SinhVien.find().select('MaSV HocBong Hoten');
  return results;
};
 ...
 */
 const cau5 = async () => {
  const results = await SinhVien.find({ hoTen: /^Anh/ });
  return results;
};
 ...
 */
 const cau6 = async () => {
  const results = await SinhVien.find().where('Nam').equals('Yes').where('hocBong').gt(0);
  return results;
};
 ...
 */
 const cau9 = async () => {
  const results = await SinhVien.find().sort('TenKhoa');
  return results;
};
 ...
 */
const cau3 = async () => {
  const results = await SinhVien.find().select('id hoTen  hocBong').where('hocBong').lt(0);
  return results;
};
